...
# setwd("/Users/amandkansal/Desktop/DIHI/Diagnosis Code/MIMIC-III Data/")
...
# all_codes <- left_join(codes, all_encounters, by = "HADM_ID")
# 
...
# all_encounters$EXPIRE_FLAG <- ifelse(is.na(all_encounters$DOD), 0, 1)
# all_encounters$death_in_month <- ifelse((all_encounters$DOD - all_encounters$ADMITTIME) > 30, 0, 1)
