...
option_list <- list(
  ...
  make_option(c("-r", "--representation"), action = "store", default ="both",
              help = "Whether to represent the data as binary or as counts. Defaults to both. Can take in either 'binary', 'count', or 'both'")
  
)

# Example run:
# Rscript run_model.R -g ahrq -m xgb -r binary
